...
| AdGuard Chinese Filter | [original](https://filters.adtidy.org/extension/ublock/filters/224.txt) | [accelerated①](https://raw.githubusercontents.com/Silentely/AdBlock-Acceleration/main/AdGuard_Chinese_Filter.txt) <sub>[copy](index.html?mirror=ghucs&copy=AdGuard_Chinese_Filter.txt)</sub> | [accelerated②](https://cdn.jsdelivr.net/gh/Silentely/AdBlock-Acceleration/AdGuard_Chinese_Filter.txt) <sub>[copy](index.html?mirror=jsdelivr&copy=AdGuard_Chinese_Filter.txt)</sub> | [accelerated③](https://raw.cosr.eu.org/AdGuard_Chinese_Filter.txt) <sub>[copy](index.html?mirror=cosr&copy=AdGuard_Chinese_Filter.txt)</sub> | [accelerated④](https://raw.gitmirror.com/Silentely/AdBlock-Acceleration/main/AdGuard_Chinese_Filter.txt) <sub>[copy](index.html?mirror=gitmirror&copy=AdGuard_Chinese_Filter.txt)</sub> |
| uBlock filters | [original](https://raw.githubusercontent.com/uBlockOrigin/uAssets/master/filters/filters.txt) | [accelerated①](https://raw.githubusercontents.com/Silentely/AdBlock-Acceleration/main/uBlock_filters.txt) <sub>[copy](index.html?mirror=ghucs&copy=uBlock_filters.txt)</sub> | [accelerated②](https://cdn.jsdelivr.net/gh/Silentely/AdBlock-Acceleration/uBlock_filters.txt) <sub>[copy](index.html?mirror=jsdelivr&copy=uBlock_filters.txt)</sub> | [accelerated③](https://raw.cosr.eu.org/uBlock_filters.txt) <sub>[copy](index.html?mirror=cosr&copy=uBlock_filters.txt)</sub> | [accelerated④](https://raw.gitmirror.com/Silentely/AdBlock-Acceleration/main/uBlock_filters.txt) <sub>[copy](index.html?mirror=gitmirror&copy=uBlock_filters.txt)</sub> |
| AWAvenue Ads Rule | [original](https://raw.githubusercontent.com/TG-Twilight/AWAvenue-Ads-Rule/main/AWAvenue-Ads-Rule.txt) | [accelerated①](https://raw.githubusercontents.com/Silentely/AdBlock-Acceleration/main/AWAvenue_Ads_Rule.txt) <sub>[copy](index.html?mirror=ghucs&copy=AWAvenue_Ads_Rule.txt)</sub> | [accelerated②](https://cdn.jsdelivr.net/gh/Silentely/AdBlock-Acceleration/AWAvenue_Ads_Rule.txt) <sub>[copy](index.html?mirror=jsdelivr&copy=AWAvenue_Ads_Rule.txt)</sub> | [accelerated③](https://raw.cosr.eu.org/AWAvenue_Ads_Rule.txt) <sub>[copy](index.html?mirror=cosr&copy=AWAvenue_Ads_Rule.txt)</sub> | [accelerated④](https://raw.gitmirror.com/Silentely/AdBlock-Acceleration/main/AWAvenue_Ads_Rule.txt) <sub>[copy](index.html?mirror=gitmirror&copy=AWAvenue_Ads_Rule.txt)</sub> |
| AdGuard Base Filter | [original](https://filters.adtidy.org/extension/ublock/filters/2.txt) | [accelerated①](https://raw.githubusercontents.com/Silentely/AdBlock-Acceleration/main/AdGuard_Base_Filter.txt) <sub>[copy](index.html?mirror=ghucs&copy=AdGuard_Base_Filter.txt)</sub> | [accelerated②](https://cdn.jsdelivr.net/gh/Silentely/AdBlock-Acceleration/AdGuard_Base_Filter.txt) <sub>[copy](index.html?mirror=jsdelivr&copy=AdGuard_Base_Filter.txt)</sub> | [accelerated③](https://raw.cosr.eu.org/AdGuard_Base_Filter.txt) <sub>[copy](index.html?mirror=cosr&copy=AdGuard_Base_Filter.txt)</sub> | [accelerated④](https://raw.gitmirror.com/Silentely/AdBlock-Acceleration/main/AdGuard_Base_Filter.txt) <sub>[copy](index.html?mirror=gitmirror&copy=AdGuard_Base_Filter.txt)</sub> |
| AdGuard Mobile Ads Filter | [original](https://filters.adtidy.org/extension/ublock/filters/11.txt) | [accelerated①](https://raw.githubusercontents.com/Silentely/AdBlock-Acceleration/main/AdGuard_Mobile_Ads_Filter.txt) <sub>[copy](index.html?mirror=ghucs&copy=AdGuard_Mobile_Ads_Filter.txt)</sub> | [accelerated②](https://cdn.jsdelivr.net/gh/Silentely/AdBlock-Acceleration/AdGuard_Mobile_Ads_Filter.txt) <sub>[copy](index.html?mirror=jsdelivr&copy=AdGuard_Mobile_Ads_Filter.txt)</sub> | [accelerated③](https://raw.cosr.eu.org/AdGuard_Mobile_Ads_Filter.txt) <sub>[copy](index.html?mirror=cosr&copy=AdGuard_Mobile_Ads_Filter.txt)</sub> | [accelerated④](https://raw.gitmirror.com/Silentely/AdBlock-Acceleration/main/AdGuard_Mobile_Ads_Filter.txt) <sub>[copy](index.html?mirror=gitmirror&copy=AdGuard_Mobile_Ads_Filter.txt)</sub> |
| Baidu Ad Block | [original](https://raw.githubusercontent.com/banbendalao/ADgk/master/kill-baidu-ad.txt) | [accelerated①](https://raw.githubusercontents.com/Silentely/AdBlock-Acceleration/main/kill-baidu-ad.txt) <sub>[copy](index.html?mirror=ghucs&copy=kill-baidu-ad.txt)</sub> | [accelerated②](https://cdn.jsdelivr.net/gh/Silentely/AdBlock-Acceleration/kill-baidu-ad.txt) <sub>[copy](index.html?mirror=jsdelivr&copy=kill-baidu-ad.txt)</sub> | [accelerated③](https://raw.cosr.eu.org/kill-baidu-ad.txt) <sub>[copy](index.html?mirror=cosr&copy=kill-baidu-ad.txt)</sub> | [accelerated④](https://raw.gitmirror.com/Silentely/AdBlock-Acceleration/main/kill-baidu-ad.txt) <sub>[copy](index.html?mirror=gitmirror&copy=kill-baidu-ad.txt)</sub> |
